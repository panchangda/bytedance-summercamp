		...
		<view class="u-index-bar">
			...
			<view v-if="showSidebar" class="u-index-bar__sidebar" @touchstart.stop.prevent="onTouchMove" @touchmove.stop.prevent="onTouchMove"
			 @touchend.stop.prevent="onTouchStop" @touchcancel.stop.prevent="onTouchStop">
				<view v-for="(item, index) in indexList" :key="index" class="u-index-bar__index" :style="{zIndex: zIndex + 1, 
				color: activeAnchorIndex === index ? activeColor : '','background-color':activeAnchorIndex === index ? activeBackgroundColor : ''}"
				 :data-index="index">
					{{ item }}
				</view>
			</view>
